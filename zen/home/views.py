...
def session(request):
    ...
    face_classifier = cv2.CascadeClassifier(r'E:\SEM-7\sgpProject\ZEN\zen\home\haarcascade_frontalface_default.xml')
    classifier = load_model(r'E:\SEM-7\sgpProject\ZEN\zen\home\model.h5')
